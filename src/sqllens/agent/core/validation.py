...
def validate_pydantic_models_in_package(package_name: str) -> Dict[str, Any]:
    ...
    Args:
        package_name: Name of the package to validate (e.g., 'sqllens.agent.core')
...
def check_models_health() -> bool:
    ...
    """
    core_packages = [
        "sqllens.agent.core.tool.models",
        "sqllens.agent.core.user.models",
        "sqllens.agent.core.llm.models",
        "sqllens.agent.core.storage.models",
        "sqllens.agent.core.agent.models",
    ]
