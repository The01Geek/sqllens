"""
ChromaDB integration for SQL Lens agent.
"""
...
def create_sentence_transformer_embedding_function(
    ...
    Examples:
        ...
        >>> from sqllens.agent.integrations.chromadb import ChromaAgentMemory, create_sentence_transformer_embedding_function
