...
| O-13 | [`README.md:136`](../../README.md#L136) | Phase 4 line names the extracted-from parent product, violating CLAUDE.md's brand-cleanliness rule. | Rewrite Phase 4 as "JWT verifier (JWKS + shared-secret) and permission scopes" with no parent-product reference. |
