...
**Category:** Reliability / DX · **Status:** Landed (PR #38)
...
**Resolution:** [`src/sqllens/preflight.py`](../../src/sqllens/preflight.py)
adds `probe_database`, `probe_llm`, `probe_memory`, `probe_auth`, and a
